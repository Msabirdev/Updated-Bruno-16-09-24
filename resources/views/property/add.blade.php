    ...
    <div id="kt_app_content_container" class="app-container  container-xxl "
        ...
        <form action="{{ isset($property) ? route('property.save', $property->id) : route('property.save') }}"
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10" data-select2-id="select2-data-142-usbz">
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9 sticky-bottom">
                    <div class="d-flex align-items-center">
                        <!--begin::Button-->
                        <a href="{{ route('property.list') }}" id="kt_ecommerce_add_product_cancel" class="btn btn-danger me-3">
                            Back
                        </a>
                        <!--end::Button-->

                        <!--begin::Button-->
                        <button type="submit" id="kt_ecommerce_add_product_submit" class="btn btn-secondary me-3">
                            {{ isset($property) ? 'Save Property' : 'Save Property' }}
                        </button>
                        <!--end::Button-->
