            ...
            <div class="modal-body px-5 my-7">
                ...
                <form id="kt_modal_add_user_form" class="form" action="#" wire:submit="submit" enctype="multipart/form-data">
                    ...
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                        ...
                        @php
                        $fields = [
                            ['label' => 'First Name', 'name' => 'first_name', 'type' => 'text', 'placeholder' => 'First Name', 'wire_model' => 'first_name'],
                            ['label' => 'Last Name', 'name' => 'last_name', 'type' => 'text', 'placeholder' => 'Last Name', 'wire_model' => 'last_name'],
                            ['label' => 'Email', 'name' => 'email', 'type' => 'email', 'placeholder' => 'example@domain.com', 'wire_model' => 'email'],
                            ['label' => 'CRM Location ID', 'name' => 'location_id', 'type' => 'text', 'placeholder' => 'Location ID', 'wire_model' => 'location_id'],
                            ['label' => 'Password', 'name' => 'password', 'type' => 'password', 'placeholder' => 'Password', 'wire_model' => 'password']
                        ];
                    ...
                    @endphp
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="{{ $field['type'] }}" wire:model="{{ $field['wire_model'] }}" name="{{ $field['name'] }}"
                                class="form-control form-control-solid mb-3 mb-lg-0" placeholder="{{ $field['placeholder'] }}" />
                            <!--end::Input-->
                            @error($field['name'])
