            ...
            <div class="card card-flush h-md-50 mb-5 mb-xl-10 ">
                ...
                <div class="card-header pt-5">
                    ...
                    <div class="card-title d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Amount-->
                            <span class="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2 top_total_contacts_count">0</span>
                            <!--end::Amount-->
                ...
                <div class="card-body pt-2 pb-4 d-flex align-items-center mb-2">
                    ...
                    <div class="d-flex flex-column content-justify-center w-100 ">
                        ...
                        <div class="d-flex fs-6 fw-semibold align-items-center my-3">
                            <!--begin::Bullet-->
                            <div class="bullet w-8px h-6px rounded-2" style="background-color: #1cc88a"></div>
                            <!--end::Bullet-->
                            <!--begin::Label-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div
                                        ...
                                        <div class="me-5">
                                            ...
                                            <!--begin::Desc-->
                                            <span
                                                class="text-gray-500 fw-semibold fs-7 d-block text-start ps-0">{{ $cov['total'] }}
                                                total</span>
                                            <!--end::Desc-->
                                        </div>
                                        <!--end::Content-->
                ...
                <div class="card-header pt-5">
                    ...
                    <div class="card-title d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Amount-->
                            <span class="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2 top_total_sales_count">0</span>
                            <!--end::Amount-->
    ...
    <div class="row media gx-5 gx-xl-10 mb-xl-10" style="display: none">
        ...
        <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
            ...
            <div class="card  card-flush h-72  mb-5 mb-xl-10">
                ...
                <!--begin::Card body-->
                <div id="top_avg_daily_sales_chart_old" style="min-width: 70px; " data-kt-size="70"
                    data-kt-line="11" class="p-5">
    ...
    <div class="row gx-5 gx-xl-10 mt-xl-10">
                                ...
                                <div class="d-flex flex-stack mb-3">
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        @elseif($opportunity['source'] === 'Direct Traffic')
                                            <img src="{{ asset('icons/direct_traffic.png') }}"
                                                class="w-55px ms-n1 me-10" alt="">
                                        @else
                                            <img src="{{ asset('icons/others.png') }}" class="w-55px ms-n1 me-10"
                                                alt="">
                                        @endif
                                        <!--end::Icon-->
        ...
        @foreach ($finalOpportunities as $key => $opportunity)
            <div class="modal fade" id="modal_{{ $key }}" tabindex="-1"
                aria-labelledby="modalLabel_{{ $key }}" aria-hidden="true">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header bg-primary text-black">
                            <h5 class="modal-title font-semibold text-white text-lg "
                                id="modalLabel_{{ $key }}">{{ $opportunity['source'] ?? 'Unknown' }}
                                Details</h5>
                                                    ...
                                                    <table
                                                        ...
                                                        <thead>
                                                            <tr class="bg-light fw-bold">
                                                                <th class="w-[100px] text-center py-3 px-4">Source
                                                                </th>
                                                                <th class="w-[100px] text-center py-3 px-4">Count</th>
                                                                <th class="w-[100px] text-center py-3 px-4">Total
                                                                    Value
                                                                </th>
                                                        ...
                                                        <tbody class="bg-white divide-y divide-gray-200">
                                                            @foreach ($opportunity['details'] as $detail)
                                                                <tr class="hover:bg-gray-100">
                                                                    ...
                                                                    <td class="px-4 py-2 border-b">€
                                                                        {{ number_format($detail['total_value'], 2) }}
                                                                    </td>
                                                                    <td class="px-4 py-2 border-b">
